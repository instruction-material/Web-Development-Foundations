# JSM7 Helper Functions and Event Listeners supplemental 3

Course: JavaScript Level 2: JavaScript Master
Module: JSM7 Helper Functions and Event Listeners supplemental 3
...
Quick run hint: open `index.html` in a browser
